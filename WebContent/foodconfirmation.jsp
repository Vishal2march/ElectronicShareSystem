	...
	<div id="content">
		<div class="container-fluid">
			<div class="lock-container" style="width: 450px;">
				<h1>
            <tr>
								<td><label for="congratulationfood"><fmt:message key="foodconfirmation.label.congratulations" /></label></td>
				...
				<div class="panel panel-default text-center"
					...
					<div class="panel-body">
						...
						<!--  -->
						<tr>
						<td><%=request.getAttribute("userID") %> <label for="food.confirm"><fmt:message key="foodconfirmation.label.confirm" /></label> <%=request.getAttribute("foodID")%></td>
						</tr>
