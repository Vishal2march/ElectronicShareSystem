...
<h1>
            <tr>
								<td><label for="forgot.password"><fmt:message key="forgotpassword.label.accaccess" /></label></td>
																	</tr>
                </h1>
                ...
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <input class="form-control" type="email" id="inputEmail13" placeholder="Email">
                        
                        <a href="login.jsp" class="btn btn-primary"><label for="forgotpassword"><fmt:message key="forgotpassword.label.forgotpassword" /></label></a>
