		...
		<div class="list-sections animated-middle">
			...
			<ul>
				...
				<li class="item-list"> <!-- 1 / .who part -->
					...
					<a href="BookModuleViewServlet" class="open-popup-link">
				
						<div class="item-title">
							<h2><span class="point" style="color:#72c14c;"><label for="get"><fmt:message key="booksmodule.label.get" /></label> </span> <strong><label for="clothes"><fmt:message key="booksmodule.label.clothes" /></label></strong></h2>
						</div> <!-- .item-title -->

						<div class="item-plus"><p><label for="getSomeones"><fmt:message key="booksmodule.label.getSomeones" /></label><br><label for="clickAvailable"><fmt:message key="booksmodule.label.clickAvailable" /></label></p><br>
				...
				<li class="item-list"> <!-- 2 / .when part -->
					...
					<!-- Link to open the popup -->
					<a href="postbook.jsp" class="open-popup-link">
				
						<div class="item-title">
                            <h2><span class="point" style="color:#72c14c;"><label for="share"><fmt:message key="booksmodule.label.share" /></label> </span> <strong><label for="clothes"><fmt:message key="booksmodule.label.clothes" /></label></strong></h2>
						</div> <!-- .item-title -->

						<div class="item-plus"><p><label for="shareYours"><fmt:message key="booksmodule.label.ShareCloths" /></label><br><label for="clickEnterCloth"><fmt:message key="booksmodule.label.clickEnterCloth" /></label></p><br>
							<svg version="1.1" id="Layer_1" width="60px" height="60px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve">
