	...
	<div id="content">
		<div class="container-fluid">
			<div class="lock-container" style="width: 450px;">
				<h1>
            <tr>
								<td><label for="congratulations"><fmt:message key="clothconfirmation.label.congratulations" /></label></td>
																	</tr>
                </h1>
				<div class="panel panel-default text-center"
					...
					<div class="panel-body">
						...
						<!--  -->
						<tr>
						<td><%=request.getAttribute("userID") %> <label for="cloth.confirm"><fmt:message key="clothconfirmation.label.confirm" /></label> <%=request.getAttribute("clothID")%></td>
						</tr>
